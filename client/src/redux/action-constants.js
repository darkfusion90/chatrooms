...
export const SET_TOTAL_PUBLIC_ROOMS_COUNT = 'SET_TOTAL_PUBLIC_ROOMS_COUNT'
export const UPDATE_USER_ROOM_MEMBERSHIP = 'UPDATE_USER_ROOM_MEMBERSHIP'
export const UPDATE_USER_ROOM_MEMBERSHIP_BULK = 'UPDATE_USER_ROOM_MEMBERSHIP_BULK'
